...
void PrintOutputResult(const std::vector<float>& data, const std::vector<std::string>& synset) {
    ...
    printf("Prediction: [%s] id = %d, probability = %.8f\n",
...
void runTest(void) {
    ...
    test_file = "/media/denis/Linux/ar13.thirdparty/trunk/prj.thirdparty/mxnetserver/banana.jpg";

    // Models path for your model, you have to modify it
    std::string json_file = "/home/denis/mxnet/inception/Inception-BN-symbol.json";
    std::string param_file = "/home/denis/mxnet/inception/Inception-BN-0126.params";
    std::string synset_file = "/home/denis/mxnet/inception/synset.txt";
    std::string nd_file = "/home/denis/mxnet/inception/mean_224.nd";
